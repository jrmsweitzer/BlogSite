...
namespace Selenium
{
    public class Logger
    {
        ...
        private static readonly Dictionary<string, Logger> LoggerDict =
        ...
        {
            return GetLogger(descriptiveLogName, ConfigurationManager.AppSettings["logDirectory"]);
        }

        public static Logger GetLogger(string descriptiveLogName, string logDirectory)
        {
